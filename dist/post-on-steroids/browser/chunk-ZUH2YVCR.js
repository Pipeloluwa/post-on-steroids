import{b as $}from"./chunk-Q6VX7CUF.js";import{a as Q,n as q}from"./chunk-GGVVBVXJ.js";import{B as _,Ba as c,C as w,Ca as l,Ea as M,Fa as B,G as u,Ga as T,Ha as y,Ia as v,K as E,L as S,La as N,Ma as O,Na as A,Ra as W,T as h,Ta as j,Ua as H,Wa as K,Z as I,aa as k,ba as a,cb as U,ha as P,ib as d,kb as b,lb as p,ra as R,sa as L,ua as V,ub as z,va as F,vb as C,wa as D}from"./chunk-XXE5LNTV.js";var G=class i{platformId=u(I);iframe=null;messageListener=null;constructor(){C(this.platformId)&&this.initializeSandbox()}readyPromise;initializeSandbox(){this.readyPromise=new Promise(n=>{this.iframe=document.createElement("iframe"),this.iframe.setAttribute("sandbox","allow-scripts"),this.iframe.style.display="none",this.iframe.onload=()=>n(),document.body.appendChild(this.iframe);let t="<!DOCTYPE html><html><head><script>"+`
